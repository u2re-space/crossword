...
import { makeEvents, objectExcludeNotExists } from "../editors/EntityEdit";
...
>(
    ...
    // Use BeerCSS card classes and ui-phosphor-icon instead of ui-icon
    const iconEl = entityItem?.icon ?
        H`<ui-phosphor-icon icon="${entityItem.icon}" style="width: 1.5rem; height: 1.5rem;"></ui-phosphor-icon>` :
        cropFirstLetter(entityItem?.title ?? entityDesc.label ?? "C");
    ...
    <div class="card-avatar">
        <div class="avatar-inner">${iconEl}</div>
    </div>
    ...
    <div class="card-actions">
        <button class="btn btn-small" on:click=${events.doEdit}><ui-phosphor-icon icon="pencil" style="width: 1rem; height: 1rem;"></ui-phosphor-icon><span>Edit</span></button>
        <button class="btn btn-small" on:click=${events.doDelete}><ui-phosphor-icon icon="trash" style="width: 1rem; height: 1rem;"></ui-phosphor-icon><span>Delete</span></button>
    </div>
