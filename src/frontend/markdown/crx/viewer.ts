import { createMarkdownViewer } from "../viewer/MarkdownViewer";
...
void (async () => {
  ...
  // Create and mount the markdown viewer
  ...
  mount.appendChild(viewerElement);

  // Once the viewer mounts, hide the raw layer.
