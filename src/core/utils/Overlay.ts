/**
 * Standalone Overlay System
 * Works independently in any context: PWA, Chrome Extension content scripts, vanilla JS
 * Provides overlay, selection box, hints, and toast functionality
 */
...
// Overlay styles (inlined for isolation in content scripts)
...
/**
 * Get or create overlay elements with lazy initialization
 */
 ...
 */
export const showToast = (text: string, config?: Partial<OverlayConfig>): void => {
...
/**
 * Initialize overlay on document ready
 */
...
// Export individual element getters for compatibility
